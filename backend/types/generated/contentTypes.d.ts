...
export interface ApiDealerRequestDealerRequest
  extends Struct.CollectionTypeSchema {
  collectionName: 'dealer_requests';
  info: {
    displayName: 'Dealer-Request';
    pluralName: 'dealer-requests';
    singularName: 'dealer-request';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::dealer-request.dealer-request'
    > &
      Schema.Attribute.Private;
...
export interface ApiProductBoxProductBox extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    TechParams: Schema.Attribute.Text;
